...
const CHART_DATA = {
  tag:   [{l:'Mo',v:45},{l:'Di',v:120},{l:'Mi',v:65},{l:'Do',v:200},{l:'Fr',v:85},{l:'Sa',v:310},{l:'So',v:175}],
  monat: [{l:'Nov',v:820},{l:'Dez',v:1240},{l:'Jan',v:680},{l:'Feb',v:950},{l:'Mär',v:1100},{l:'Apr',v:760}],
  jahr:  [{l:'2022',v:4200},{l:'2023',v:6800},{l:'2024',v:3200}],
}
      ...
      {data.map((d, i) => (
        <div key={i} className="flex-1 flex flex-col items-center gap-1.5">
          <div className="w-full relative group cursor-default">
            <div className="w-full bg-indigo-500 hover:bg-indigo-600 rounded-t-md transition-all"
              style={{height: Math.max((d.v/max)*100, d.v>0?4:0)}}/>
...
export default function Dashboard() {
  ...
  const [goals]                 = useState({ day: 150, month: 500 })
  const [relistDays]            = useState(5)
  ...
  const periodMeta = { tag:{revenue:175,sales:2,label:'Heute'}, monat:{revenue:760,sales:8,label:'April'}, jahr:{revenue:3200,sales:24,label:'2024'} }
