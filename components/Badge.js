...
export const CATEGORIES = [
  ...
  'Damen – Kleidung – Bauchfreie Tops',
  'Damen – Kleidung – Schulterfreie Tops',
  'Damen – Kleidung – Blusen & Tuniken',
  'Damen – Kleidung – Hosen & Jeans',
  'Damen – Kleidung – Shorts',
  'Damen – Kleidung – Pullover & Strickpullover',
  'Damen – Kleidung – Pullover & Strickpullover – Pullover',
  'Damen – Kleidung – Pullover & Strickpullover – Strickjacken',
  'Damen – Kleidung – Pullover & Strickpullover – Hoodies & Sweatshirts',
  'Damen – Kleidung – Pullover & Strickpullover – Westen',
  'Damen – Kleidung – Blazer & Anzüge',
  'Damen – Kleidung – Unterwäsche & Socken',
  'Damen – Kleidung – Sportkleidung',
  'Damen – Kleidung – Bademode',
  'Damen – Kleidung – Overalls & Jumpsuits',
  // ── Damen – Schuhe ─────────────────────────────────────────────────
  'Damen – Schuhe',
  'Damen – Schuhe – Sneakers',
  'Damen – Schuhe – Stiefel & Stiefeletten',
  'Damen – Schuhe – Pumps & Absatzschuhe',
  'Damen – Schuhe – Sandalen',
  'Damen – Schuhe – Ballerinas & Flats',
  'Damen – Schuhe – Sportschuhe',
  'Damen – Schuhe – Hausschuhe',
  // ── Damen – Taschen & Accessoires ──────────────────────────────────
  'Damen – Taschen',
  'Damen – Accessoires',
  'Damen – Beauty',
  // ── Herren – Kleidung ──────────────────────────────────────────────
  ...
  'Herren – Kleidung – Bademode',
  // Herren Pullover & Sweater – alle Unterkategorien (live auf Vinted bestätigt)
  'Herren – Kleidung – Pullover & Sweater – Sweater',
  'Herren – Kleidung – Pullover & Sweater – Pullis & Hoodies',
  'Herren – Kleidung – Pullover & Sweater – Kapuzenjacken',
  'Herren – Kleidung – Pullover & Sweater – Strickjacken',
  'Herren – Kleidung – Pullover & Sweater – Pullover mit Rundhalsausschnitt',
  'Herren – Kleidung – Pullover & Sweater – Pullover mit V-Ausschnitt',
  'Herren – Kleidung – Pullover & Sweater – Rollkragenpullover',
  'Herren – Kleidung – Pullover & Sweater – Lange Pullover',
  'Herren – Kleidung – Pullover & Sweater – Strickpullover für den Winter',
  'Herren – Kleidung – Pullover & Sweater – Westen',
  // ── Herren – Schuhe ────────────────────────────────────────────────
  'Herren – Schuhe',
  'Herren – Schuhe – Sneakers',
  'Herren – Schuhe – Stiefel & Stiefeletten',
  'Herren – Schuhe – Sportschuhe',
  'Herren – Schuhe – Halbschuhe & Mokassins',
  'Herren – Schuhe – Sandalen & Flip-Flops',
  'Herren – Schuhe – Hausschuhe',
  'Herren – Accessoires',
  // ── Kinder – Mädchen ───────────────────────────────────────────────
  ...
  'Kinder – Mädchen – Pullover & Jäckchen',
